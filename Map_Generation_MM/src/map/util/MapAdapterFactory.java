...
public class MapAdapterFactory extends AdapterFactoryImpl {
	...
	protected MapSwitch<Adapter> modelSwitch =
		new MapSwitch<Adapter>() {
			...
			@Override
			public Adapter caseIsland(Island object) {
				return createIslandAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link map.Grid <em>Grid</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link map.GridType <em>Grid Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link map.Island <em>Island</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIslandAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link map.Sea <em>Sea</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
