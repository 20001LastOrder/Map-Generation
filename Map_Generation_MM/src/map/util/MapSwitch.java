...
public class MapSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MapPackage.GRID_TYPE: {
				GridType gridType = (GridType)theEObject;
				T result = caseGridType(gridType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapPackage.ISLAND: {
				Island island = (Island)theEObject;
				T result = caseIsland(island);
				if (result == null) result = caseGridType(island);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapPackage.SEA: {
				...
				if (result == null) result = caseGridType(sea);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Island</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Island</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIsland(Island object) {
		return null;
	}
